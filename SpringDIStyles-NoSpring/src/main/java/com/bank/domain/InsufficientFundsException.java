...
public class InsufficientFundsException extends Exception {
	...
	public InsufficientFundsException(String targetAccountId, double targetAccountBalance, double attemptedAmount) {
	...
	public String toString() {
		return String.format(
				...
				this.getAttemptedAmount(), this.getTargetAccountId(), this.getTargetAccountBalance(),
				this.getOverage());
	}
}